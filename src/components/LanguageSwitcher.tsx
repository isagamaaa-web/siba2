...
function loadWidget(): Promise<void> {
  ...
  widgetLoader.promise = new Promise((resolve) => {
    injectHideStyle();
    ...
    (window as unknown as { googleTranslateElementInit: () => void }).googleTranslateElementInit = () => {
      ...
      // Wait for the hidden <select.goog-te-combo> to appear.
...
async function applyLanguage(code: string) {
  ...
  if (code === "en") {
    // Easiest reliable way to return to source language.
